...
object HistoricalDataUnificationAndProcessing {
  ...
  // main method which does the downloading, processing and unifying the data and stores in the required format, which will be ready to use in an unified and consistent format for all the data
  def main() = {
